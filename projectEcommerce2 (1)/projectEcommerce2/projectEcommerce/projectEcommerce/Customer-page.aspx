<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer-page.aspx.cs" Inherits="projectEcommerce.Customer_page" %>
                            ...
                            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <div><asp:Button class="btn btn-primary" ID="Button2" runat="server"  Text="Search"  OnClick="Button2_Click" /></div>
                                    </div>
                                </div>
                            </form>
...
</table>--%><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
