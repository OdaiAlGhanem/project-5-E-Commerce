                    ...
                    <div id="content">
                            ...
                            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <div><asp:Button class="btn btn-primary" ID="Button2" runat="server"  Text="Search"  OnClick="Button2_Click" style="background-color:#4e73df; margin-top:2px ;" /></div>
                                        <div><asp:Button class="btn btn-primary" ID="Button3" runat="server"  Text=""  OnClick="Button3_Click" style="background-color:#4e73df;border:solid 3px ;margin-left:5px ; " /></div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div style="float: right;">
                                <asp:Button ID="Button1" runat="server" Text="+ Create Item" BackColor="#4e73df" ForeColor="White" OnClick="Button1_Click" class="btn btn-primary" />
                                <br /><br />
                            </div>
                            <%--<main>
